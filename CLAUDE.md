...
### First-Time Setup
When `LIBRARY.md` exists but hasn't been configured yet (library_name is still "My Library"), ask the user for the library name, owner, and purpose, then fill in the Configuration block and update the title.
